<?php
    ...
    $result_prod = "SELECT * FROM produtos WHERE nomeproduto LIKE '%$busca%' LIMIT 1";
    $resultado_prod = mysqli_query($conecta, $result_prod);
    
     while($rows_prod = mysqli_fetch_array($resultado_prod)){
        echo "<b> Resultado da busca: </b><br>";
        echo "Nome do prod: ".$rows_prod['nomeproduto']."<br>";
        echo "Preço: R$  ".$rows_prod['precovenda']."<br>";
        echo "<hr>";
	}
?>
<!doctype html>
